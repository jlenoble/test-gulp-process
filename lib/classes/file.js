...
var File = function () {
  ...
  (0, _createClass3.default)(File, [{
    ...
    value: function cache() {
      ...
      this._cache[this.filepath] = { file: this, content: content, stats: stats };
      if (this.debug) {
        console.info('Cache size is now: ' + (0, _keys2.default)(this._cache).length);
      }
    ...
    value: function isNewer() {
      ...
      return this._cache[this.filepath].stats.then(function (stat1) {
    ...
    value: function isSameContent() {
      ...
      return this._cache[this.filepath].content.then(function (content1) {
