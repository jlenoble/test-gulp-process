...
var newDest = exports.newDest = function newDest() {
  counter++;
  return '/tmp/' + new Date().getTime() + '_' + counter;
};

var copySources = exports.copySources = function copySources(options) {
...
var copyGulpfile = exports.copyGulpfile = function copyGulpfile(options) {
  return new _promise2.default(function (resolve, reject) {
...
var copyBabelrc = exports.copyBabelrc = function copyBabelrc(options) {
  return new _promise2.default(function (resolve, reject) {
    _gulp2.default.src('.babelrc').on('end', resolve).on('error', reject).pipe(_gulp2.default.dest(options.dest));
  });
};

var linkNodeModules = exports.linkNodeModules = function linkNodeModules(options) {
