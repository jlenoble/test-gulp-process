...
Object.defineProperty(exports, 'nextTarget', {
  enumerable: true,
  get: function get() {
    return _testTools.nextTarget;
  }
});
...
function testGulpProcess(opts) {
  return function () {
    ...
    var targets = opts.target || ['default'];

    if (!Array.isArray(targets)) {
      targets = [targets];
    }

    var tests = targets.map(function (target, nth) {
