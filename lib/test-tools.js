...
var compareTranspiled = exports.compareTranspiled = function compareTranspiled(_glob, _dest) {
  return function (options) {
    ...
    var glob = (0, _polypath.rebase)(_glob, options.dest);
...
var deleteFile = exports.deleteFile = function deleteFile(_file) {
  return function (options) {
    var exec = function exec() {
      var _rebase = (0, _polypath.rebase)(_file, options.dest),
...
var isDeleted = exports.isDeleted = function isDeleted(_file) {
  return function (options) {
    var _rebase3 = (0, _polypath.rebase)(_file, options.dest),
        _rebase4 = (0, _slicedToArray3.default)(_rebase3, 1),
        file = _rebase4[0];
...
var isFound = exports.isFound = function isFound(_file) {
  return function (options) {
    var _rebase5 = (0, _polypath.rebase)(_file, options.dest),
        _rebase6 = (0, _slicedToArray3.default)(_rebase5, 1),
        file = _rebase6[0];
...
var touchFile = exports.touchFile = function touchFile(_file) {
  return function (options) {
    var _rebase7 = (0, _polypath.rebase)(_file, options.dest),
        _rebase8 = (0, _slicedToArray3.default)(_rebase7, 1),
        file = _rebase8[0];
